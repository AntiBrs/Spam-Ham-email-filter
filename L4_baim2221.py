...
def preprocess_data(directory, stopwords_file, stopwords_file2, filenames):
    files = []
    contents = {}
    names = []
    stopwords = read_stopwords(stopwords_file) + read_stopwords(stopwords_file2)
...
train_ham = preprocess_data('enron6/ham', 'stopwords2.txt', 'stopwords.txt', 'train.txt')
train_spam = preprocess_data('enron6/spam', 'stopwords2.txt', 'stopwords.txt', 'train.txt')

test_ham = preprocess_data('enron6/ham', 'stopwords2.txt', 'stopwords.txt', 'test.txt')
test_spam = preprocess_data('enron6/spam', 'stopwords2.txt', 'stopwords.txt', 'test.txt')
